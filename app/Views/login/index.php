...
<div class="row p-3">
    <div class="col-sm-12">
        <div class="row d-flex justify-content-center">
            <img src="<?php echo base_url('assets/imagens/logo_php_exp.png') ?>" alt="Logo do PHP Money" style="height: 150px;">
        </div>
        <div class="row d-flex justify-content-center">
            <h2>Sistema de Controle de Atividade Complementares</h2>
        </div>
    </div>
</div>
<hr>
