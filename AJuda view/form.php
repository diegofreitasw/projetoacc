    ...
    <div class="card-body">
        ...
        <div class="form-group col-sm-8">
            ...
            <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="sim_consolidado" name="consolidado" class="custom-control-input" value="1" <?php echo !empty($lancamento['consolidado']) && $lancamento['consolidado'] == '1' ? 'checked' : set_radio('consolidado', '1', true) ?> />
                <label class="custom-control-label text-default" for="sim_consolidado">Sim</label>
            </div>
            <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="nao_consolidado" name="consolidado" class="custom-control-input" value="2" <?php echo !empty($lancamento['consolidado']) && $lancamento['consolidado'] == '2' ? 'checked' : set_radio('consolidado', '2') ?> />
        ...
        <div class="form-group col-md-7">
            ...
            <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="sim_notificar" name="notificar_por_email" class="custom-control-input" value="1" <?php echo !empty($lancamento['notificar_por_email']) && $lancamento['notificar_por_email'] == '1' ? 'checked' : set_radio('notificar_por_email', '1') ?>>
                <label class="custom-control-label text-default" for="sim_notificar">Sim</label>
            </div>
            <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="nao_notificar" name="notificar_por_email" class="custom-control-input" value="2" <?php echo !empty($lancamento['notificar_por_email']) && $lancamento['notificar_por_email'] == '2' ? 'checked' : set_radio('notificar_por_email', '2', true) ?>>
